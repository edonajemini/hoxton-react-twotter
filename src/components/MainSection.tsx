...
export function MainSection({ tweets, setTweets }) {
    ...
    return(
       ...
       onSubmit={event => {event.preventDefault()
        const tweetCopy = structuredClone(tweets)
        let newTweet = { 
          tweet: event.target.tweet.value
        }
        tweetCopy.push(newTweet);
        //update State
        setTweets(tweetCopy)
        }}>
          <img
  ...
  <div className="tweet-info-counts">
    ...
    <div className="message">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>
    </div>
  </div>
</div>
      </section>
